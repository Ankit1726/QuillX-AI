...
from backend.agent import app as workflow
...
def stream_workflow(
    ...
    try:
        ...
        # Retrieve the final checkpoint when the root reducer & update did not contain the complete final output.
